<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="StoreSearch.aspx.cs" Inherits="FindAfternoonTea.FAT.FATweb.StoreSearch" %>
...
<body>
    ...
    <div class="world" align="center">
        ...
        <div id="main">
        <asp:DataList ID="DataList1" runat="server" CellSpacing="100" DataKeyField="Id" DataSourceID="SqlDataSource1" RepeatColumns="3" RepeatDirection="Horizontal" CellPadding="0" OnItemCommand="DataList1_ItemCommand">
            <ItemTemplate>
